export default async (context, locale) => {
  return await Promise.resolve({
      ...
      bad: {
        ...
        recruitee: {
          msgs: {
            ...
            ts1: '13:39',
            msg2: 'Obawiam się, że nie o takie informacje mi chodziło. Ach, wypełniłem tę ankietę, niestety jednak nie nazwałbym jej krótką... 😞',
            ts2: '14:10',
          },
        },
      },
    ...
    footer: {
      ...
      footer_lang_nontech:
        ', albo w wersji nieco mniej nastawionej na rekrutację IT po:',
    },
  })
}
